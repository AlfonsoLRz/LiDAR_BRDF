...
public:
	...
	*/
	...
	/**
	*	@brief Defines the VBO for a texture coordinate.
	*/
	void defineColorTextCoordVBO();

	/**
	*	@brief
	*/
	void defineGPSTimeVBO();

	/**
	*	@brief Defines a VBO which wraps the intensity value of a collision point.
	*/
	void defineIntensityVBO();

	/**
	*	@brief Defines a VBO which wraps the normal vector of a collision point.
	*/
	void defineNormalVBO();

	/**
	*	@brief Defines a VBO for a buffer which saves the return number of a triangle-ray collision.
	*/
	void defineReturnNumberVBO();

	/**
	*	@brief Defines a VBO for a buffer which saves the division of return number and number of returns of ray.
	*/
	void defineReturnPercentageVBO();
	...
	*	@brief
	*/
	void defineScanAngleRankVBO();

	/**
	*	@brief 
	*/
	void defineScanDirectionVBO();
