...
#define LIDAR_TRACKING true
#define TRACKING_DISTANCE 4.0f
...
protected:
	...
	*/
	...
	/**
	*	@brief Prints the new LiDAR position whether it is separated by x from last valid position.
	*/
	void debugLiDARTracking();
