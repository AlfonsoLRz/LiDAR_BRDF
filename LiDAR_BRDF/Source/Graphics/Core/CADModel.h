...
public:
	const static std::string ASPRS_CLASSES_EXTENSION;		//!< File extension for ASPRS semantic concepts
	const static std::string BINARY_EXTENSION;				//!< File extension for binary models
	const static std::string CUSTOM_CLASSES_EXTENSION;		//!< File extension for custom semantic concepts
	const static std::string MATERIAL_EXTENSION;			//!< File extension for material specifications
...
protected:
	/**
	*	@brief Assigns ASPRS classes from file to models.
	*/
	bool assignASPRSClasses();

	/**
	*	@brief Assigns custom classes to models from a file.
	*/
	bool assignCustomClasses();

	/**
	*	@brief Assigns LiDAR materials to each model from a file.
	*/
	bool assignMaterial();
