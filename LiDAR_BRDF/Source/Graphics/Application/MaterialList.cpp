...
void MaterialList::defineMaterials()
{
	...
	_materialSpecs[CGAppEnum::MATERIAL_LEAVES_LIDAR]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_GRAY_127;
	_materialSpecs[CGAppEnum::MATERIAL_LEAVES_LIDAR]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_64;
	_materialSpecs[CGAppEnum::MATERIAL_LEAVES_LIDAR]._shininess = 200.0f;
	...
	_materialSpecs[CGAppEnum::MATERIAL_TRUNK_LIDAR]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_GRAY_192;
	_materialSpecs[CGAppEnum::MATERIAL_TRUNK_LIDAR]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_BLACK;
	_materialSpecs[CGAppEnum::MATERIAL_TRUNK_LIDAR]._shininess = 249.019f;

	_materialSpecs[CGAppEnum::MATERIAL_WATER]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_WATER_LAKE_ALBEDO;
	_materialSpecs[CGAppEnum::MATERIAL_WATER]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_240;
	...
	_materialSpecs[CGAppEnum::MATERIAL_WEED_PLANT_LIDAR]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_GRAY_192;
	_materialSpecs[CGAppEnum::MATERIAL_WEED_PLANT_LIDAR]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_64;
	_materialSpecs[CGAppEnum::MATERIAL_WEED_PLANT_LIDAR]._shininess = 120.0f;
	...
	_materialSpecs[CGAppEnum::MATERIAL_CAD_WHITE]._texture[Texture::NS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_127;
	_materialSpecs[CGAppEnum::MATERIAL_CAD_WHITE]._shininess = 100.0f;

	// LiDAR
	_materialSpecs[CGAppEnum::MATERIAL_CANISTER]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_CANISTER_ALBEDO;
	_materialSpecs[CGAppEnum::MATERIAL_CANISTER]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_CANISTER_SPECULAR;
	_materialSpecs[CGAppEnum::MATERIAL_CANISTER]._texture[Texture::BUMP_MAPPING_TEXTURE] = CGAppEnum::TEXTURE_CANISTER_NORMAL;
	_materialSpecs[CGAppEnum::MATERIAL_CANISTER]._shininess = 150.0f;

	_materialSpecs[CGAppEnum::MATERIAL_DRONE]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_DRONE_ALBEDO;
	_materialSpecs[CGAppEnum::MATERIAL_DRONE]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_DRONE_SPECULAR;
	_materialSpecs[CGAppEnum::MATERIAL_DRONE]._texture[Texture::BUMP_MAPPING_TEXTURE] = CGAppEnum::TEXTURE_DRONE_NORMAL;
	_materialSpecs[CGAppEnum::MATERIAL_DRONE]._shininess = 20.0f;

	_materialSpecs[CGAppEnum::MATERIAL_INTENSITY_VEGETATION]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_GRAY_64;
	_materialSpecs[CGAppEnum::MATERIAL_INTENSITY_VEGETATION]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_64;
	_materialSpecs[CGAppEnum::MATERIAL_INTENSITY_VEGETATION]._shininess = 50.0f;

	_materialSpecs[CGAppEnum::MATERIAL_LIDAR_HEIGHT]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_LIDAR_HEIGHT;
}
