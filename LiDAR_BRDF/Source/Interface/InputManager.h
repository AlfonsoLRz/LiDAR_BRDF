...
protected:
	...
	static const float				MOVEMENT_SPEED_UP;					//!< Multiplier for general dolly speed as another key is pressed
	static const float				SCENE_MULTIPLIER;					//!< Multiplier regarding the scene dimensions

	// [Keys constraints]
	static const int				ANIM_SCENE;
...
protected:
	...
	*/
	...
	/**
	*	@return Movement multiplier for any scene. Therefore, this factor depends on its size.
	*/
	float getSceneMovementMultiplier(LiDARScene* scene);
