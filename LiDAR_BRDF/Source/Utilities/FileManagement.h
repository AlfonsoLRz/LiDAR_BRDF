...
namespace FileManagement
{
	...
	*/
	bool writeString(const std::string& filename, const std::string& message);
};
...
inline bool FileManagement::writeString(const std::string& filename, const std::string& message)
{
